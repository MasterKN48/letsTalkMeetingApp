...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Real-time translation, voice cloning, and ultra-low latency video calls.",
  ...
  return (
    ...
    >
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Iosevka+Charon+Mono:wght@300;400;500&display=swap"
          rel="stylesheet"
        />
        <style>{`
          :root {
