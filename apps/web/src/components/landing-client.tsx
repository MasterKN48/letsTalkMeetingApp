...
export default function LandingClient({ initialUserName = '' }: LandingClientProps) {
          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground font-medium leading-relaxed max-w-sm">
                Next-gen SFU meetings with real-time translation and voice cloning.
              </p>
            </div>
            ...
            <div className="bg-card/40 backdrop-blur-3xl border-2 border-border/50 p-10 md:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                <div className="space-y-4">
                  <label className="text-[10px] font-black text-foreground uppercase tracking-[0.3em] ml-2">Identity</label>
                  <div className="relative">
                    <User className="absolute left-6 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" size={20} />
                    <input
                      type="text"
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative flex items-center gap-6 py-2">
                    ...
                    <span className="text-muted-foreground text-[10px] font-black uppercase tracking-widest opacity-30 italic">secure</span>
                    <div className="h-[1px] flex-1 bg-border/50" />
                  </div>

                  <form onSubmit={joinRoom} className="space-y-6">
                    <div className="relative">
                      <Video className="absolute left-6 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" size={20} />
                      <input
                        type="text"
      ...
      <section id="features" className="w-full max-w-7xl px-6 py-32 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-black uppercase tracking-tight">Real-time Translation</h3>
            <p className="text-sm text-muted-foreground font-medium leading-relaxed">
              Break language barriers with instant AI-powered voice and text translation during your calls.
            </p>
          </motion.div>
          <motion.div 
            whileHover={{ y: -10 }}
          ...
          >
            ...
            <h3 className="text-xl font-black uppercase tracking-tight">Voice Cloning</h3>
            <p className="text-sm text-muted-foreground font-medium leading-relaxed">
              Communicate in any language while maintaining your natural voice tone and expression.
            </p>
          </motion.div>
          <motion.div 
            whileHover={{ y: -10 }}
          ...
          >
            ...
            <h3 className="text-xl font-black uppercase tracking-tight">SFU Engine</h3>
            <p className="text-sm text-muted-foreground font-medium leading-relaxed">
              Ultra-low latency Selective Forwarding Unit architecture powered by Mediasoup and Bun.
            </p>
          </motion.div>
        </div>
      </section>
